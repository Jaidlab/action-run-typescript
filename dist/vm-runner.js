  ...
  static getIDToken(audience) {
    return __awaiter3(this, undefined, undefined, function* () {
      try {
        ...
        debug2(`ID token url is ${id_token_url}`);
...
import { createRequire as createRequire2, isBuiltin } from "node:module";
...
class VmModuleRuntime {
  ...
  resolveExternalModuleSpecifier(specifier, parentIdentifier) {
    ...
    const requireParentPath = parentIdentifier.startsWith("file:") ? fileURLToPath(parentIdentifier) : path6.join(process.cwd(), "__action_run_typescript_require__.mjs");
...
var createGlobalValues = (payload) => Object.assign(Object.create(null), payload.bindings, { core: exports_core }, payload.globals);
...
var isMainModule = () => {
  ...
  return path7.resolve(mainModulePath) === entryPath;
};
